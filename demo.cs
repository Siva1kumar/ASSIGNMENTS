...
namespace shiva
{
    ...
    {
       // const string FileName = @"C:\Users\Siva kumar\source\repos\assignment\assignment\EmpData.csv";
        public const string FileName = @"C:\Users\Siva kumar\source\repos\assignment\assignment\EmpData.csv";//CSV is a text based file where data is represented in the form of text where each line represents an individual record and each record has multiple values seperated by , where each value represents info about the record. 
